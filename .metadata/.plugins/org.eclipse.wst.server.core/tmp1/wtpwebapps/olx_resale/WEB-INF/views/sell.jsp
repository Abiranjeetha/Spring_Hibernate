...
<div class="container">
 ...
 <div class="card">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
        <input type="text" class="form-control" id="txt" placeholder="Enter item name" name="itemname" required>
      </div>
    </div>
    <div class="form-group">
      ...
      <select class="form-control" id="sel1" name="categoryname" required>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
        <input type="text" class="form-control" id="txt" placeholder="Enter price" name="price" required>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="txt">Years of usage:</label>
      <div class="col-sm-8">          
        <input type="text" class="form-control" id="txt" placeholder="Enter no of years" name="yearsofusage" required>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="txt">Quantity:</label>
      <div class="col-sm-8">          
        <input type="text" class="form-control" id="txt" placeholder="Enter quantity" name="quantity" required>
      </div>
    </div>
     <div class="form-group">
